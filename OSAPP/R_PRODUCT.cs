...
namespace OSAPP
{
    public partial class R_PRODUCT : Form
    {
        ...
        private void textBoxQUANTITY_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                panel3.Visible = false;
                buttonUPRODUCT.Text = "UPDATE PRODUCT";
            ...
            else
            {
                panel3.Visible = true;
                decimal quantity;
                if (decimal.TryParse(textBoxQUANTITY.Text, out quantity) && quantity > 0)
                {
                    buttonUPRODUCT.Text = "RESTOCK PRODUCT";
                    label4.Text = "RESTOCK PRODUCT"; 
                }
                else
                {
                    buttonUPRODUCT.Text = "UPDATE PRODUCT";
